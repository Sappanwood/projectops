...
test("Reports and Retrospectives put rendered bodies before technical records", () => {
  const data: WorkbenchReadPages = {
    plans: [], documents: [], diagnostics: [],
    reports: [{schema:"report/Report@1", id:"report-reading", title:"Reading", project:"alpha", created_at:"2026-09-05", outcome:"completed", plan:"project-ops:plans/plan-reading.json", backlog:[], verification:["Passed"], deviations:[], workarounds:[], repo_docs:[], body:"## Evidence\n**Report body**"}],
    retrospectives: [{schema:"retrospective/Retrospective@1", id:"retro-reading", project:"alpha", task:null, created_at:"2026-09-05", trigger:"workflow-friction", status:"inbox", harness:"test", model:null, path:"inbox/retro-reading.md", revision:"revision-123", body:"## Friction\n**Retro body**"}],
  };
  ...
  const crossProject = renderReadPages("retrospectives",data,{project:"",status:"",task:""},{projectId:"alpha",planId:null});
